...
export const menu2 = {
  popular: ["pop1", "pop2", "pop3", "pop4", "pop5"],
  pizzas: ["pizza,pizza,pizza,pizza,pizza,pizza,pizza,"],
  schnizel: ["schnizel,schnizel,schnizel,schnizel,schnizel"],
  baguettes: ["baguettes", "baguettes", "baguettes", "baguettes"],
  salads: ["salads,salads,salads,salads,salads"],
  desserts: ["desserts, desserts,desserts,desserts"],
  drinks: ["Cola", "Fanta", "Sprite"],
  snacks: ["pommes", "chicken nuggets", "currywurst"],
};
